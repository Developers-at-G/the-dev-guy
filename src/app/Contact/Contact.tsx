  ...
  const contactMethods = [
    {
      ...
      subtitle: t('contact.connect_with_me', 'common'),
      value: 'gueye.amadou1996@gmail.com',
      href: 'mailto:gueye.amadou1996@gmail.com',
      description: t('contact.open_message', 'common')
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      subtitle: t('contact.linkedin_desc', 'common'),
      value: '/in/abdallah-amadou-gueye',
      href: 'https://www.linkedin.com/in/abdalah-amadou-gueye/',
      description: t('contact.work_together_message', 'common')
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      subtitle: t('contact.github_desc', 'common'),
      value: '@abdallah96',
