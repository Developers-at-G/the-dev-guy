...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        'service_12345678', // Replace with your actual service ID
        'template_12345678', // Replace with your actual template ID
        {
    ...
    <section className="relative py-32 overflow-hidden" id="contact">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-foreground px-4 py-2 rounded-lg border border-white/20 hover:border-primary/30 hover:bg-primary/10 transition-all duration-300"
                  >
            ...
            {/* Contact Form */}
            <div className="bg-gradient-to-br from-white/10 via-background/80 to-accent/10 backdrop-blur-xl rounded-2xl border-2 border-primary/20 shadow-2xl p-8">
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-sm rounded-2xl bg-background border border-primary/20 shadow-2xl p-6">
