...
const translations = {
  en: {
    ...
    'profile.software_engineer': 'Frontend / Product Engineer',
    ...
    'education.bachelor_desc': 'Comprehensive study of computer science fundamentals, Frontend / Product Engineering principles, and practical application development. Focused on modern web technologies, database systems, and software architecture.',
    ...
    // Case Study
    'case_study.back': 'Back to Portfolio',
    'case_study.case_study': 'Case Study',
    'case_study.completed_mvp': 'Completed MVP',
    'case_study.full_stack': 'Full-Stack Development',
    'case_study.summary': 'Project Summary',
    'case_study.problem': 'The Problem',
    'case_study.goals': 'Goals',
    'case_study.tech_stack': 'Tech Stack',
    'case_study.implementation': 'Technical Implementation',
    'case_study.challenges': 'Challenges & Solutions',
    'case_study.lessons': 'Key Lessons',
    'case_study.future': 'Future Improvements',
    'case_study.links': 'Project Links',
  ...
  fr: {
    ...
    // Case Study
    'case_study.back': 'Retour au Portfolio',
    'case_study.case_study': 'Étude de Cas',
    'case_study.completed_mvp': 'MVP Terminé',
    'case_study.full_stack': 'Développement Full-Stack',
    'case_study.summary': 'Résumé du Projet',
    'case_study.problem': 'Le Problème',
    'case_study.goals': 'Objectifs',
    'case_study.tech_stack': 'Stack Technique',
    'case_study.implementation': 'Implémentation Technique',
    'case_study.challenges': 'Défis & Solutions',
    'case_study.lessons': 'Leçons Clés',
    'case_study.future': 'Améliorations Futures',
    'case_study.links': 'Liens du Projet',
