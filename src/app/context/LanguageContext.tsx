...
const translations = {
  en: {
    ...
    'howibuild.subtitle': 'My approach to building modern, maintainable, and scalable web applications with React & Next.js.',
    'howibuild.back': 'Back to Portfolio',
    'howibuild.note': 'Note: This page highlights the core React & Next.js concepts I use in this portfolio. My experience extends far beyond these—let\'s chat if you want to know more!',
    'howibuild.component_title': 'Component',
    'howibuild.component_desc': 'A component is a reusable, self-contained piece of UI. In React, everything is a component, from buttons to entire pages. Components help you organize your code and make it modular.',
    'howibuild.component_why': 'Shows I write modular, maintainable code.',
    'howibuild.state_title': 'State',
    'howibuild.state_desc': 'State is data that changes over time in your app. React\'s useState hook lets you add state to your components, enabling interactivity.',
    'howibuild.state_why': 'I can build interactive, dynamic UIs.',
    'howibuild.effect_title': 'Effect',
    'howibuild.effect_desc': 'Effects let you run code in response to changes in your component (like fetching data or setting up a timer). React\'s useEffect hook is used for this.',
    'howibuild.effect_why': 'I know how to handle side effects and async logic.',
    'howibuild.context_title': 'Context',
    'howibuild.context_desc': 'Context provides a way to pass data through the component tree without having to pass props down manually at every level.',
    'howibuild.context_why': 'I can build scalable state management solutions.',
    'howibuild.memo_title': 'Memo & Callback',
    'howibuild.memo_desc': 'useMemo and useCallback help optimize performance by memoizing values and functions to prevent unnecessary re-renders.',
    'howibuild.memo_why': 'I write performant React applications.',
    'howibuild.reducer_title': 'Reducer',
    'howibuild.reducer_desc': 'useReducer is useful for managing complex state logic that involves multiple sub-values or when the next state depends on the previous one.',
    'howibuild.reducer_why': 'I can handle complex state logic efficiently.',
    'howibuild.props_title': 'Props',
    'howibuild.props_desc': 'Props are how you pass data from parent to child components. They make your components flexible and reusable.',
    'howibuild.props_why': 'I build flexible, reusable components.',
    'howibuild.routing_title': 'Next.js Routing',
    'howibuild.routing_desc': 'Next.js uses file-based routing. Each file in the \'app\' or \'pages\' directory becomes a route. This makes navigation and code organization simple.',
    'howibuild.routing_why': 'I organize projects for scalability and easy navigation.',
    'howibuild.ssr_title': 'SSR & SSG',
    'howibuild.ssr_desc': 'Next.js lets you render pages on the server (SSR) or at build time (SSG) for better performance and SEO.',
    'howibuild.ssr_why': 'I care about performance and SEO.',
    'howibuild.why_matters': 'Why it matters:',
    
    // Popup System
    'popup.profile_title': 'Profile Section',
    'popup.profile_desc': 'A dynamic hero section featuring a typewriter effect and professional presentation.',
    'popup.skills_title': 'Skills Section',
    'popup.skills_desc': 'Interactive skills showcase with animated progress bars and technology icons.',
    'popup.career_title': 'Career Section',
    'popup.career_desc': 'Professional experience timeline with company details and role descriptions.',
    'popup.coding_title': 'Coding Demo',
    'popup.coding_desc': 'Interactive coding animation showcasing development workflow and technical skills.',
    'popup.projects_title': 'Projects Section',
    'popup.projects_desc': 'Portfolio showcase with project cards, filtering, and interactive elements.',
    'popup.education_title': 'Education Section',
    'popup.education_desc': 'Academic background presentation with degree details and achievements.',
    'popup.achievement_title': 'Achievement Section',
    'popup.achievement_desc': 'Accomplishments and certifications showcase with visual elements.',
    'popup.contact_title': 'Contact Section',
    'popup.contact_desc': 'Contact form and information with interactive elements and validation.',
    'popup.approach': 'Approach',
