        ...
        >
          <Button variant="ghost" size="sm" asChild>
            <Link href="/Projects">
              ...
              {t('projects.back_to_projects', 'common')}
            </Link>
          </Button>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2 space-y-8">
            ...
            {project.impacts && project.impacts.length > 0 && (
              ...
              >
                <Card variant="elevated" className="p-6 md:p-8">
                  <h2 className="text-2xl font-bold text-foreground mb-4">{t('projects.results_impact', 'common')}</h2>
          ...
          <div className="space-y-6">
            ...
            >
              <Card variant="elevated" className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">{t('projects.project_links', 'common')}</h3>
                  ...
                  {project.link && (
                    <Button className="w-full" size="lg" asChild>
                      ...
                      >
                        ...
                        {t('projects.view_live_site', 'common')}
                      </a>
                    </Button>
                  )}
                  {project.githubUrl && (
                    <Button variant="outline" className="w-full" size="lg" asChild>
                      ...
                      >
                        ...
                        {t('projects.view_source_code', 'common')}
                      </a>
                    </Button>
                  )}
                </div>
