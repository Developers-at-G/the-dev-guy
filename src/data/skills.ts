...
const iconMap: Record<string, Record<string, string>> = {
  ...
  Zustand: { icon: '/Images/code.png' },
  'TanStack Query': { icon: '/Images/code.png' },
  ...
  'Chrome Extensions': { icon: '/Images/code.png' },
